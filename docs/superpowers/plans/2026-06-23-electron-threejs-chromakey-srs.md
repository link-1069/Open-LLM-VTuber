...
- [x] **Step 4: Implement material module**
...
- [x] **Step 3: Update `renderer.js` orchestration**
...
- [x] **Step 1: Package metadata sanity**

Run: `npm ls three`

Expected: installed `three@0.142.x`.

- [x] **Step 2: Electron start smoke**
...
- [x] **Step 3: Playwright Electron real-window test**
...
- Verification notes: `npm test` passed with 19 tests; `npm run test:e2e` passed against a temp Electron user-data dir; `npm ls three` reports `three@0.142.0`.
