...
- **Create an issue**: `gh issue create --title "..." --body "..."`. Use a PowerShell here-string for multi-line bodies.
- **Read an issue**: `gh issue view <number> --comments`, filtering comments and also fetching labels.
